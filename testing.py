...
f = fixedPointIteration(G,1,[(G.getNode("s"),G.getNode("t"),PWConst([0,10],[3],0))],50,10)
print(f)
networkLoading(f).fPlus[G.edges[0],0].drawGraph(0,10).show()
networkLoading(f).fPlus[G.edges[1],1].drawGraph(0,10).show()
networkLoading(f).queues[G.edges[0]].drawGraph(0,10).show()
networkLoading(f).queues[G.edges[1]].drawGraph(0,10).show()
